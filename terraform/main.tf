...
resource "aws_instance" "pear_ec2_instance" {
  ami           = "ami-0b7e05c6022fc830b"
  instance_type = "t3.micro"
  key_name      = "pear-key"
  tags = {
    Name = "pear_ec2_instance"
  }
...
resource "aws_eip" "pear_ec2_eip" {
  instance = aws_instance.pear_ec2_instance.id
  domain   = "vpc"
}

output "ec2_host" {
  value = aws_eip.pear_ec2_eip.public_dns
